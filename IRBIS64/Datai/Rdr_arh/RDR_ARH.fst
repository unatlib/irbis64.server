...
40 0 (|SH=|v40^A/)
/*40 0 "AR="v40^G,"/"v40^A
60 0 mhl,&uf('+7W1#'),&uf('+7W2#'),(if p(v40) then if (v40^a<>'') then &uf('+7U1#',v40^d,| |v40^1,| 000000|N40^1,|/|v40^v) fi,if (v40^f.1<>'*') and (v40^a<>'') then &uf('+7U1#',v40^f,| |v40^2,| 000000|N40^2,|/|v40^v) fi,if (v40^L<>'') and (v40^a<>'') then &uf('+7U1#',v40^L,| |v40^3,| 000000|N40^3,|/|v40^v) fi,if (v40^a='') then &uf('+7U2#',v40^d,|/|v40^v) fi fi),&uf('++B1#30'),&uf('+7U1#',(g2/)),&uf('+7T1'),(|VS=|g1/),,,(if g1<>'' then 'SV=',&uf('G2/',g1),'/',&uf('G0/',g1),/,fi),,,,&uf('+7W3#',&uf('30')),&uf('+7W4#'),(if g1<>'' then if &uf('Ag3#1')=g1.4 then &uf('+7W4#1'),break fi fi),/if g4='' then 'PRG=мер' else 'PRG=дю' fi,
