...
488 0 MHL,(if p(v488^c) then if v488^u:'1'then else |T=|d488^c,&unifor(|9|v488^c),if a(v488^z) then |;|v488^v fi fi fi,|%|d488/) 
...
691 0 MHL,(if p(v691) then if p(v691^u) then if s(v691^d,v691^i)<>''then'VUZU=',v691^d,if a(v691^d) then &unifor('DVUZ,!IDD=',v691^i,'!,v3^a,|=|v3^b,|(|v3^0|)|') fi fi,' - 'v691^g,| ОСН |n691^g fi fi,|%|d691/) 
6911 0 MHL,(if p(v691) then if p(v691^w) and a(v691^u) then if s(v691^d,v691^i)<>''then'VUZD=',v691^d,if a(v691^d) then &unifor('DVUZ,!IDD=',v691^i,'!,v3^a,|=|v3^b,|(|v3^0|)|') fi fi,' - 'v691^g,| ОСН |n691^g fi fi,|%|d691/) 
