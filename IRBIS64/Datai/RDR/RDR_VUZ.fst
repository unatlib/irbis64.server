999 0 mhl,"VIS="v999
60 0 &uf('+7W40#',(v40/)),&uf('+7U40#',&uf('7RDR_ARH,!RI=',v30,'!,(v40/)')),mhl,&uf('+7W1#'),&uf('+7W2#'),(if p(g40) then if (g40^a<>'') then &uf('+7U1#',g40^d,| |g40^1,| 000000|N40^1,|/|g40^v) fi,if (g40^f.1<>'*') and (g40^a<>'') then &uf('+7U1#',g40^f,| |g40^2,| 000000|N40^2,|/|g40^v) fi,if (g40^L<>'') and (g40^a<>'') then &uf('+7U1#',g40^L,| |g40^3,| 000000|N40^3,|/|g40^v) fi,if (g40^a='') then &uf('+7U2#',g40^d,|/|g40^v) fi fi),&uf('++B1#30'),&uf('+7U1#',(g2/)),&uf('+7T1'),(|VS=|g1/),if &uf('31')>='09' then &uf('+7W3#',&uf('30'),'0901') else &uf('+7W3#',f(val(&uf('30'))-1,4,0),'0901') fi,&uf('+7W4#'),(if g1<>'' then if &uf('Ag3#1')<=g1.8 then &uf('+7W4#1'),break fi fi),/if g4='' then 'PRG=ÍÅÒ' else 'PRG=ÄÀ' fi,
40 0 &uf('+7W40#',(v40/)),&uf('+7U40#',&uf('7RDR_ARH,!RI=',v30,'!,(v40/)')),(if g40^a<>'' then |DV=|g40^d.6,/|AR=|g40^g,|/|g40^a fi,if g40<>'' then '%' fi/)
40 0 &uf('7LICH,!RI=',v30,'!,"AR="v5,"/"v6/')
40 0 &uf('+7W40#',(v40/)),&uf('+7U40#',&uf('7RDR_ARH,!RI=',v30,'!,(v40/)')),(if (g40^f<>'******') and (g40^a<>'') then|DW=|g40^f.6 fi,if g40<>'' then '%' fi/)
